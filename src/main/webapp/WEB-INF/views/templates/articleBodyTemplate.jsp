...
+"<p><div class='category'>${labelCategory}: <span class='article__category'></span></div> <div class='button float_r'><a href=' ' class='more'>${labelRead}</a></div>"+"<div class='cleaner'></div>"
