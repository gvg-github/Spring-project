...
<body>
<c:url value="/authors/add" var="add"/>
            ...
            <div class="post_section">
                <form action="${add}" method="POST">
                    <c:if test="${author != null}">
                        <c:set var="category" scope="page" value="${author}"/>
                        <input placeholder="Id" type="hidden" name="id" value="${author.id}">
                        <input placeholder="First name" type="text" name="firstname" value="${author.firstname}">
                        <input placeholder="Last name" type="text" name="lastname" value="${author.lastname}">
                        <input placeholder="Email" type="text" name="email" value="${author.email}">
